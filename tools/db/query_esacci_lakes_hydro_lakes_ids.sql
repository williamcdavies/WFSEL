...
-- Description: 
--     Queries HYDROLakes v1.0 polygons against ESA Lakes Climate Change
--     Initiative (Lakes_cci): Lake products, Version 3.0 centroid data
--     to match `hylak_id`s to `esacci_lakes_id`s. 
